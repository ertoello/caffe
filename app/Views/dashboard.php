...
<head>
    ...
    <!-- endinject -->
    <link rel="shortcut icon" href="<?= base_url() ?>/public/images/coffee.jpg" />
</head>
            ...
            <div class="navbar-menu-wrapper d-flex align-items-top">
                <ul class="navbar-nav">
                    <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
                        <h1 class="welcome-text">Selamat Datang, Di Caffe Kami<span class="text-black fw-bold">:)</span></h1>
                        <p>Selamat datang di Coffee Caffe, tempat di mana setiap tegukan adalah sebuah perjalanan rasa. </p>
                    </li>
                </ul>
            ...
            <div class="main-panel" style="margin-left: auto; margin-right:auto;">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body p-0 text-center">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input type="text" id="nama" class="form-control" aria-label="Amount (to the nearest dollar)" autocomplete="off">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group">
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text bg-warning text-white">No. WhatsApp</span>
                                                </div>
                                                <input type="number" id="noMeja" class="form-control" style="-webkit-appearance: none;  -moz-appearance: textfield;" aria-label="Amount (to the nearest dollar)" autocomplete="off">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <b id="peringatan" class="badge badge-danger">Silahkan isi Nama dan No.WhatsApp yang aktif.</b><br>
                            </div>
                ...
                <div class="modal fade" id="modalSelesai" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel"style="font-size:1.5rem;">Pesanan Berhasil.</h5>
                            </div>
                            <div class="modal-body">
                                Pesanan Berhasil dibuat. atas nama <b id="namaPemesan"></b>  dengan No. WhatsApp <b id="lokasiMeja"></b>.
                                <br> <br>Utuk proses lebih lanjut, mohon klik "Konfirmasi Pemesanan". Konfirmasi pemesanan dilanjutkan melalui Via WhatsApp.<br> <br><b>============Terimakasih============</b><br><br>
                                <i>Jangan Lupa Siapkan Uang Tunai Anda!!!</i>
                            </div>
                            <div class="modal-footer">
                                <a href="https://wa.me/62881010930936?text=Hallo!!! Mohon segera PROSESKAN pesanan saya. Terima Kasih" target="_blank" class="btn btn-warning" onclick="tutupModalSelesai()">Konfirmasi Pemesanan</a>
                                <!-- <button type="button" class="btn btn-warning">Siap :)</button> -->
                            </div>
                        </div>
                    </div>
                </div>
