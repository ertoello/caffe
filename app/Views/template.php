...
<head>
    ...
    <title>Coffe Caffe | <?= $url->getSegment(3) ?> </title>
    <!-- plugins:css -->
            ...
            <div class="navbar-menu-wrapper d-flex align-items-top">
                <ul class="navbar-nav">
                    <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
                        ...
                        <h3  class="welcome-sub-text"> Semanga dalam bekerja yaa, <span><?= session()->get("nama") ?></span>!!! Jangan Lupa budayakan SENYUM </h3>
                    </li>
                </ul>
